import HautevilleHouse.CondensedMatterLandauGinzburgTheoryCanonicalLaneLean.FinalTheorem
...
Landau-Ginzburg endgame pilot. The pilot closes over its admitted class and carries the
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleFreeEnergyClass, LandauGinzburgClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact landau_ginzburg_endgame A
